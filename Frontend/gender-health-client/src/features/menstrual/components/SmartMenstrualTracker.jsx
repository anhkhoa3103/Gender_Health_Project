...
const SmartMenstrualTracker = ({ customerId }) => {
    ...
    const radius = 140;         // nhỏ hơn
    const center = 180;        // nhỏ hơn
    const dotRadius = radius - 15; // để dot bên trong
            ...
            <div className="top-section">
                ...
                <div className="form-section">
                    <div className="form-container">
                        <h3 className="form-title">Ngày {selectedDate.toLocaleDateString('vi-VN')}</h3>
